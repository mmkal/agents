...
Codex task: `01a08fcb-6e83-7472-afde-4f75daeeca3b`  
Host: `local`  
Title: Global PR monitor

This one task watches PRs across repositories. Send registrations with Codex's `send_message_to_thread`; include the PR URL, your task ID/host, worktree, and UTC expiry. Follow the [registration and monitor protocol](skills/pr-monitor/references/global-monitor.md).
